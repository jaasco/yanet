...
def create_packet(sni: str, src_ip: str, dst_ip: str, ttl: int = 64):
    eth = Ether(src="00:1b:21:a6:d4:65", dst="90:e2:ba:ce:c1:8c")/ Dot1Q(vlan=1209)
...
pkts = []
for i in range(100):
    pkt = create_packet("good.exampe.com",src_ip=f"192.168.0.{i}", dst_ip="192.168.0.1")
    pkts.append(pkt)

wrpcap("multi-flow.pcap", pkts)
