...
protected:
	...
	void loadConfig_tls_inspect(controlplane::base_t& baseNext, const std::string& moduleId, const nlohmann::json& moduleJson, const std::string&, const std::map<std::string, nlohmann::json>&);
